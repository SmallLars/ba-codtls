...
\begin{itemize}
  ...
  \item \textbf{server-tiny}: \acr{dtls}-Server mit TinyDTLS. Zu groß für den \glos{mc1322}: aber notwendig für den Größenvergleich einiger Komponenten.
  \item \textbf{sniffer}: Aus Contiki entnommener Sniffer, der mit der IP-Adresse aaaa::60b1:60b1:60b1:0028 konfiguriert ist. Außerdem sind einige Mitschnitte von \glospl{handshake} enthalten.
