...
\TODO{motivation für das kapitel}
...
Der Header eines \glos{handshake}-Pakets setzt sich gemäß Abbildung \ref{fig:handshakelayer} zusammen. Während es bei TLS ausreichend ist, den Typ, die Länge und die Daten selbst
...
\glos{handshake}-Paketen antworten kann, lässt sich das bei DTLS so nicht realisieren. Da UDP kein verbindungsorientiertes Protokoll ist, können Pakete mit gefälschtem
...
\TODO{anschließend können Nutzdaten über das App-Data-Protokoll versendet werden}
\TODO{es werden die gerade ausgehandelten Sicherheitsparameter genutzt}
...
wiederholt werden, wird erneut ein Alert-Paket generiert. \TODO{wie auch alle anderen pakete -> sicherheitsparameter der aktuellen epoche, verschlüsselt}
