...
Dabei liegt ein besonderes Interesse darauf den Handshake über \acr{coap} \cite{draftcoap13} zu realisieren und somit einige in \acr{dtls} eingefügte
...
Speicher oder Effizienz gibt, und aus dem Server, der für einen Redbee Econotag \cite{econotag} mit dem \glos{mc1322}
Mikrocontroller \cite{mc1322} optimiert werden soll. Da der genannte Mikrocontroller die Verschlüsselung mit dem \acr{aes} im \acr{ctr}- und \acr{cbc}-Mode
in Hardware unterstützt und die Rechenleistung sowie der Speicher beschränkt ist, soll nur eine \glos{ciphersuite} "`TLS\_PSK\_ECDH\_WITH\_AES\_128\_CCM\_8"',
