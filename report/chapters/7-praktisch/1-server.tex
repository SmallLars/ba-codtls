...
"`Block 1"' fehlt. Diese Option wird von einem Clienten benutzt, der größere Datenmengen mit einer \acr{coap}-Anfrage versenden möchte, um diese Daten in Blöcke
zu unteteilen, damit es nicht zu einer Fragmentierung auf IP-Ebene kommt. \TODO{fortsetzen ... lösung beschreiben}
