...
\TODO{Gedanken ausformulieren / obigen Block anpassen}
\begin{itemize}
  \item Sicherheitsparameter für Paketempfang ergeben sich durch Header
  \item Client kann alte Sicherheitsparameter für Empfang und Versand nach 3. coap-Anfrage auf ungültig setzen und neue benutzen. Da Handshake sicher beendet.
  \item Server setzt alte Sicherheitsparameter bei Empfang der ersten Anwendungsdaten auf ungültig (vernichten)
\end{itemize}
