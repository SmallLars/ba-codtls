...
Hilfe des kann der QR-Code, frühzeitig in einem \acr{dtls}-Clienten hinterlegt werden, so dass die Daten bei einem Verbindungsaufbau direkt
...
\input{chapters/5-praktisch/3-0-testumgebung.tex}