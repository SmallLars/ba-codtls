...
zur Verfügung stehen soll, wurde sie in ähnlicher Form wie die Separate-Option implementiert. Das Separate-Modul bietet Methoden an, um den Client, während der
...
die Erläuterung von 3 implementierten Contiki-Apps, welche für die Realisierung von \acr{dtls} benutzt werden. Die Implementierung von \acr{dtls} wird dann
...
\input{chapters/5-praktisch/1-3-ecc.tex}
\input{chapters/5-praktisch/1-4-dtls.tex}
\input{chapters/5-praktisch/1-5-update.tex}