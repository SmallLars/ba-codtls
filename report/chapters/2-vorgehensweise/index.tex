...
in Hardware unterstützt und die Rechenleistung sowie der Speicher beschränkt ist, soll nur ein \glos{ciphersuit} "`TLS\_ECDH\_anon\_WITH\_AES\_128\_CCM\_8"',
...
lassen. Die Verschlüsselung der Anwendungsdaten erfolgt dann im "`\acr{aead}"' Modus \cite{rfc5116}
...
% TLS_PSK_ECDH_WITH_AES_128_CCM_8      neu

% aes - cbc mac bei beiden